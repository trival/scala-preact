...
$p.aD = function () {
  return $m_Lpreact_test_test$package$().j(
    "div",
    $m_sr_ScalaRunTime$().l(
      new $ac_O([
        ...
        new $c_Lpreact_test_modifier_ChildModifier(
          $m_Lpreact_test_Card2$().W(
            new $c_sjsr_WrappedVarArgs([
              new $c_Lpreact_test_modifier_AttributeModifier(
                "title",
                "My Card2 with Footer"
              ),
              new $c_Lpreact_test_modifier_AttributeModifier(
                "footer",
                "This is the footer text."
...
$p.aF = function (a, seed) {
  ...
  if (l === 0) {
    ...
    return this.o(
      this.e(h, $m_sr_Statics$().g($m_sr_ScalaRunTime$().F(a, 0))),
      1
    );
  } else {
...
$p.aQ = function (xs, seed) {
  ...
  return rangeState === 2
    ? this.aV(initial, rangeDiff, prev, seed)
    : this.o(h, n);
};
/** @constructor */
...
$p.aE = function (self, modifier) {
  if (modifier instanceof $c_Lpreact_test_modifier_AttributeModifier) {
    ...
    if (x19 === "footer") {
      return new $c_Lpreact_test_Card2(
        self.K,
        new $c_s_Some(modifier.A),
        self.z
      );
    }
    return self;
...
var $d_Lpreact_test_Card2$$anon$1 = new $TypeData().i(
  $c_Lpreact_test_Card2$$anon$1,
  "preact.test.Card2$$anon$1",
  {
    ar: 1,
    al: 1,
  }
...
$p.W = function (ms) {
  var card = new $c_sr_ObjectRef(
    new $c_Lpreact_test_Card2("", $m_s_None$(), $m_Lpreact_test_Card2$().aC())
  );
  ms.O(
    new $c_sr_AbstractFunction1_$$Lambda$70e1780b84463d18653aacefee3ab989ac625f28(
      (m$3) => {
        card.m = this.aG().aE(card.m, m$3);
      }
    )
  );
  return card.m.aZ();
};
var $d_Lpreact_test_Card2$ = new $TypeData().i(
  $c_Lpreact_test_Card2$,
  "preact.test.Card2$",
  {
    aq: 1,
    X: 1,
...
$p.aY = function (self) {
  ...
  var $x_3 = new $c_Lpreact_test_modifier_ChildModifier(
    $m_Lpreact_test_test$package$().j(
      "h3",
      $m_sr_ScalaRunTime$().l(
        new $ac_O([new $c_Lpreact_test_modifier_ChildModifier(this.a1)])
      )
    )
  );
  var $x_2 = new $c_Lpreact_test_modifier_ChildModifier(
    $m_Lpreact_test_test$package$().j(
      "div",
      $m_sr_ScalaRunTime$().l(
        new $ac_O([new $c_Lpreact_test_modifier_ChildModifier(this.Z)])
      )
    )
  );
  matchResult4: {
...
$p.aZ = function () {
  ...
  var $x_3 = new $c_Lpreact_test_modifier_ChildModifier(
    $m_Lpreact_test_test$package$().j(
      "h3",
      $m_sr_ScalaRunTime$().l(
        new $ac_O([new $c_Lpreact_test_modifier_ChildModifier(this.K)])
      )
    )
  );
  var $x_2 = new $c_Lpreact_test_modifier_ChildModifier(
    ...
    if (x16 instanceof $c_s_Some) {
      var $x_1 = new $c_Lpreact_test_modifier_ChildModifier(
        $m_Lpreact_test_test$package$().j(
          "div",
          $m_sr_ScalaRunTime$().l(
            new $ac_O([new $c_Lpreact_test_modifier_ChildModifier(x16.M)])
          )
        )
      );
      break matchResult10;
...
$p.s = function () {
  return this.w()
    ? $m_sc_Iterator$().C
    : new $c_sc_Iterator$$anon$20(this.av());
};
/** @constructor */
